...
## Template / Fields
- Canonical artifact: **spec/16_delivery_monitoring.json**
- Schema reference: `schema/16_delivery_monitoring.schema.json` (do not inline schema; rely on `$schema` in JSON artifacts)
...
## Prompt File
- Contract: `prompts/prompt_16_delivery_monitoring.md`
...
- Step 17: Spec-Drift Audit - Uses deployment and monitoring data to detect divergence.
