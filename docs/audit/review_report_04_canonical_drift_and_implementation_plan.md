...
| A-005 | `prompts/prompt_11_redteam.md` | Fix `trace` shape (array), threat required list, include `seed_refs`, align output sample | `python -m specdev_tools.cli validate spec/11_redteam.json --repo-root .` | prompt contract matches schema; generated sample validates | A-004 |
...
| D-014 | `schema/11_redteam.schema.json` | Add canonical refs for risk categories and mitigation controls | `python -m specdev_tools.cli validate spec/11_redteam.json --repo-root .` | step validates | D-001 |
