...
class Step05RouteValidationTests(unittest.TestCase):
    ...
    def test_duplicate_route_is_detected(self):
        ...
        self.assertTrue(
            ...
            f"Expected duplicate route error, got: {_render(errors)}",
        )
    ...
    def test_different_routes_are_accepted(self):
        ...
        errors = validate_step_05(instance, ".")
        route_errors = [e for e in _render(errors) if "Duplicate API method/route" in e]
    ...
    def test_backward_compat_path_field(self):
        ...
        self.assertTrue(
            any("Duplicate API method/route" in e for e in _render(errors)),
            f"Expected duplicate route error via 'path' fallback, got: {_render(errors)}",
        )
    ...
    def test_route_preferred_over_path(self):
        ...
        self.assertTrue(
            ...
            f"Expected duplicate on route, not path, got: {_render(errors)}",
        )
