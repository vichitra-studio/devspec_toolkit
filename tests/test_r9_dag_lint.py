...
class TestDagLint(unittest.TestCase):
    ...
    def test_clean_dag_all_nonterminal_have_consumers(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            errors = lint_dag(tmp)
            e596_errors = [e for e in errors if "E596 DAG_DEAD_END_PRODUCER" in e]
    ...
    def test_consumer_inconsistency_emits_e599(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            errors = lint_dag(tmp)
            e599_errors = [e for e in errors if "E599" in e]
    ...
    def test_circular_dependency_detected(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            errors = lint_dag(tmp)
            circular_errors = [e for e in errors if "DAG_CIRCULAR_DEPENDENCY" in e]
    ...
    def test_undeclared_upstream_ref_emits_w596(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            errors = lint_dag(tmp)
            w596_errors = [e for e in errors if "W596" in e]
    ...
    def test_no_prompts_dir_skips_extraction_checks(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            errors = lint_dag(tmp)
            extraction_errors = [
                e for e in errors if "W596" in e
            ]
