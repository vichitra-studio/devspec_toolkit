...
class TestCheckContentDerivation(unittest.TestCase):
    ...
    def test_sufficient_overlap_produces_no_w594(self):
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            w594_errors = [e for e in errs if "W594" in e]
    ...
    def test_missing_upstream_file_emits_w590(self):
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            w590_errors = [e for e in errs if "W590" in e]
    ...
    def test_threshold_is_configurable(self):
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            w594_pass = [e for e in errs_pass if "W594" in e]
            ...
            w594_fail = [e for e in errs_fail if "W594" in e]
